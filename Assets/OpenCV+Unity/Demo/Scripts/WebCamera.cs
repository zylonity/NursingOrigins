	...
	public abstract class WebCamera: MonoBehaviour
	{
		...
		public string DeviceName
		{
			...
			set
			{
				...
				if (-1 != cameraIndex)
				{
					webCamDevice = WebCamTexture.devices[cameraIndex]; //input.deviceName = PlayerPrefs.GetString("Camera");
					webCamTexture = new WebCamTexture(PlayerPrefs.GetString("Camera"));
